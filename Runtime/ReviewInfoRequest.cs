...
{
    public class ReviewInfoRequest : ARequest<ReviewInfoResponse>
    {
        ...
        protected override ReviewInfoResponse Convert(string data) => JsonConvert.DeserializeObject<ReviewInfoResponse>(data);
    }
}